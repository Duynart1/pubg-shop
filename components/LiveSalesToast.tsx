...
// Dàn data ngẫu nhiên siêu thật (đã trộn Tên + SĐT che số)
const names = [
    ...
    "Như Lê", "038***2468", "Quý Đạtt", "Quynh Trm"
];

// Các hành động có kèm icon cho bắt mắt
const actions = [
...
// Giá tiền đa dạng
const prices = [
    "1m2", "2m5", "3m5", "3m8", "5m5", "8m", "12m",
    "15m", "18m", "25m", "42m", "65m", "110m",
    "145m", "195m", "160m", "4m5", "2m2", "1m5", "2m", "1m", "1m8", "2m", "4m", "1m", "4m1", "4m3", "10m", "7m", "9m", "6m", "5m", "3m",
    "6m5", "7m5", "7m3", "6m1"
];

// Thời gian
const times = [
    "Vừa xong", "1 phút trước", "2 phút trước", "5 phút trước",
    "7 phút trước", "10 phút trước", "15 phút trước"
];
...
export default function LiveSalesToast() {
    ...
    useEffect(() => {
        const showInterval = setInterval(() => {
            ...
            } while (activeAccs.has(randomAcc)); // Nếu vô tình trùng mã đang có trên web -> Quay lại sinh mã khác ngay lập tức!
    ...
    return (
        <div
            className={`fixed top-24 right-6 z-[100] transition-all duration-500 ease-out transform 
